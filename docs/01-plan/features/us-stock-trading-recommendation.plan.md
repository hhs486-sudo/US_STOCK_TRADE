...
- FRED API (CPI, 장단기 금리 DGS10/DGS2, M2SL 통화량)
...
- [x] 시장 심리 지표 표시: Fear & Greed Index, VIX, 주요 지수 RSI, CPI, 장단기 금리차, M2 통화량 YoY
...
- [x] 매수 추천 점수 (심리 점수 + 낙폭 점수 + 펀더멘탈 점수, 금리차 패널티 + M2 유동성 조정 반영)
...
| FR-17 | M2 통화량 YoY 증가율 표시 및 유동성 조정 점수 반영 (FRED M2SL) | Medium | ✅ Done |
...
낙폭 점수 (0~100):
  [일반 주식] ATH 대비 낙폭 ≥ 50%    → 100점
              ATH 대비 낙폭 ≥ 30%    → 75점
              ATH 대비 낙폭 ≥ 20%    → 50점
              ATH 대비 낙폭 ≥ 10%    → 25점

  [ETF] 지수추종 특성상 낙폭이 작아 기준 세분화
        ATH 대비 낙폭 ≥ 20%    → 100점
        ATH 대비 낙폭 ≥ 15%    → 75점
        ATH 대비 낙폭 ≥ 10%    → 50점
        ATH 대비 낙폭 ≥  5%    → 25점
...
M2 유동성 조정 (m2_adjustment) — 시차(Lag) 가중치 포함:
  [기본 점수]
  YoY ≥ 15%  → +10점 (유동성 과잉)
  YoY  7~15% →  +5점 (유동성 풍부)
  YoY  0~ 7% →   0점 (건강한 성장, 중립)
  YoY -2~ 0% →  -7점 (유동성 수축)
  YoY < -2%  → -15점 (심각한 수축)

  [시차 가중치: 추세 연속 지속 개월 기준]
  수축 구간:  1~3개월 ×0.3 / 4~6개월 ×0.6 / 7~12개월 ×1.0 / 13개월+ ×0.7
  확장 구간:  1~3개월 ×0.4 / 4~9개월 ×0.8 / 10개월+  ×0.4
  → M2와 주가 사이 6~12개월 시차 반영, 점진적 가중치로 급격한 반응 방지
...
| `m2` | M2 통화량 YoY 증가율 + 연속 지속 개월 | 24시간 |
...
| 1.1 | 2026-02-19 | M2 통화량 YoY 지표 추가 + 시차 가중치 유동성 조정 점수 반영 | - |
